    ...
    def trackList(self, downloadable_only = False):
        ...
        while offset < self.user.public_favorites_count:
            ...
            try:
                ...
                self.report('(trackList) ' + sys.exc_info()[0])
                self.report('(trackList) ' + sys.exc_info()[1])
                self.report('(trackList) ' + favoritesToJoin[0].download_url)
...
### Begin operations
PATH = 'C:\\Users\\Evan\\Downloads\\ScDownloader\\'
sc = scLikesDownloader('http://www.soundcloud.com/waltermorrison', PATH)
